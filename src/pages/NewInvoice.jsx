  ...
  async function onSubmit(e) {
    ...
    try {
      const res = await fetch("http://localhost:8081/invoices", {
        ...
        // ⚠️ Adapte les clés exactement à ton backend si besoin
        body: JSON.stringify({
          buyerUsername,
          amount,
          description,
          invoiceNumber: invoiceNumber || undefined,
          // Si le backend déduit le supplier depuis le JWT, ne pas envoyer supplierUsername.
          ...
          <Stack spacing={4}>
            ...
            <FormControl>
              ...
              <Textarea
                ...
                placeholder="Détails ou référence"
              />
            </FormControl>
